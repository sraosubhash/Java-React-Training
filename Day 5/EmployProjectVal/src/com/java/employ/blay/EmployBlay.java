...
public class EmployBlay {
	...
	public String writeEmployFileBlay() throws IOException{
		return empDao.writeEmployFileDao();
	}
	
	public String readEmployFileBlay() throws ClassNotFoundException, IOException{
		return empDao.readEmployFileDao();
	}
